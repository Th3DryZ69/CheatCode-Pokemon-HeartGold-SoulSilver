...
- [Ne plus avoir un seul Badge de Kanto](#ne-plus-avoir-un-seul-badge-de-kanto)
...
- [Réobtenir un Minidraco](#réobtenir-un-minidraco)
...
- Note: Les sprites des Pokémon (en combat, dans l'équipe, dans le Pokédex etc...) seront ceux des Pokémon chromatiques. L'effet du code se dissipe dès que vous le désactivez, même si vous sauvegardez.
    ...
    Ce sont juste les sprites des Pokémon qui sont modifiés, ils ne seront pas officiellement Chromatiques !
- Code:
```
12070082 000046C0
```
...
- Manipulation: Vous devez avoir au moins 3 Pokémon sur vous !
    ...
    Les 3 derniers Pokémon de votre équipe seront remplacés, le mieux est donc d'avoir exactement 3 Pokémon pour ne perdre personne. Allez à l'Usine de Combat (solo ou duo, niveau 50 ou libre), empruntez 3 Pokémon, faites les échanges que vous voulez lors du jeu, et lorsque les 3 Pokémon que vous avez vous plaisent, pressez Select+Start pour les copier dans votre vraie équipe.
...
- Manipulation: Pressez Select durant l'épreuve du Casse Roc, votre compteur de points sera à 200 (nombre maximum).
- Code:
```
94000130 FFFB0000
B21118A0 00000000
...
- Manipulation: Pressez L+R puis allez parler à l'Homme en Vert dans un magasin pour recevoir Jirachi.
    ...
    La route évènement "Sentier du Firmament" sera disponible sur le Pokéwalker.
- Code:
```
94000130 FCFF0000
B21118A0 00000000
...
- Manipulation: Version Or HeartGold uniquement !
    ...
    Pressez Start+Select avant d'atteindre le sommet de la Tour Carillon, et PROFIT !
- Code:
```
94000130 FFF30000
B21118A0 00000000
...
```
___
### Recombattre Latias ou Latios de l'event Mystécristal
- Manipulation: Pressez Start+Select avant d'arriver à Argenta. Latias ou Latios sera présent devant le musée.
- Code:
```
94000130 FFF30000
B21118A0 00000000
...
```
___
### Refaire l'event Pichu Troizépi
- Manipulation: Pressez Start+Select puis allez à l'Autel du Bois aux Chênes avec le [Pichu Event](#obtenir-pichu-pri2010-officiel-fr) en 1ère position dans votre équipe.
- Code:
```
94000130 FFF30000
B21118A0 00000000
...
```
___
### Refaire l'event Célébi
- Manipulation: Pressez Start+Select puis allez à l'Autel du Bois aux Chênes avec le [Célébi Event](#obtenir-célébi-hvr2011-officiel-fr) en 1ère position dans votre équipe.
- Code:
```
94000130 FFF30000
B21118A0 00000000
...
```
___
### Refaire l'event Arceus
- Manipulation: Pressez Start+Select puis allez aux Ruines Alpha avec le [Arceus Event](#obtenir-arceus-michina-officiel-fr) en 1ère position dans votre équipe. Vous pourrez à nouveau refaire l'event pour choisir d'obtenir Palkia, Dialga, ou Giratina.
- Code:
```
94000130 FFF30000
B21118A0 00000000
...
___
### Recombattre Red
- Manipulation: Pressez Start+Select avant d'arriver au sommet du Mont Argenté.
- Code:
```
94000130 FFF30000
B21118A0 00000000
...
```
___
### Pokédex Jotho Complet
- Manipulation: Pressez Select

    Ce code est à utiliser si vous n'avez pas encore reçu le Pokédex National !
- Code:
```
94000130 FFFB0000
B21118A0 00000000
...
```
___
### Pokédex National Complet
- Manipulation: Pressez Select

    Ce code est à utiliser si vous avez reçu le Pokédex National !
- Code:
```
94000130 FFFB0000
B21118A0 00000000
...
```
___
### Obtenir l'étoile des Feuilles d'Or sur la Carte Dresseur
- Manipulation: Pressez Start+Select avant de regarder votre Carte Dresseur, l'étoile sera ajoutée que vous ayez fait la quête des Feuilles d'Or ou non.
- Code:
```
94000130 FFF30000
B21118A0 00000000
